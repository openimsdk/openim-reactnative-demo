...
export const formatMessageByType = (message: MessageItem): string => {
  ...
  switch (message.contentType) {
    ...
    case MessageType.FileMessage:
      return `messageDescription.fileMessage: ${
    ...
    case MessageType.MemberEnter:
      try {
        const enterDetails = JSON.parse(
          message.notificationElem.detail || '{}',
        );
        const enterUser = enterDetails.entrantUser;
        return `messageDescription.joinGroupMessage: Name - ${getName(
          enterUser,
        )}`;
      } catch (error) {
        return '';
    ...
    case MessageType.GroupCreated:
      try {
        ...
        return `messageDescription.createGroupMessage: Creator - ${getName(
          groupCreatedUser,
        )}`;
      } catch (error) {
        return '';
    ...
    case MessageType.MemberInvited:
      try {
        ...
        return `messageDescription.invitedToGroupMessage: Operator - ${getName(
          inviteOpUser,
        )}, Invited Users - ${inviteStr}${
